...
alter table notifications."notification" add constraint FKcoo21hn3vypvv73wlpbyfkguk foreign key (subscription_id) references notifications."subscription" on delete cascade
